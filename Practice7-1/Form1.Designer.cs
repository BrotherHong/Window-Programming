namespace Practice7_1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // menu_feature
            // 
            menu_feature.DropDownItems.AddRange(new ToolStripItem[] { menuItem_feature_newWord, menuItem_feature_searchWord });
            ...
            menuItem_feature_newWord.Size = new Size(122, 22);
            ...
            menuItem_feature_searchWord.Size = new Size(122, 22);
            menuItem_feature_searchWord.Text = "搜尋單字";
            menuItem_feature_searchWord.Click += menuItem_feature_searchWord_Click;
            // 
            // menu_view
            // 
            menu_view.DropDownItems.AddRange(new ToolStripItem[] { menuItem_view_font });
            ...
            menuItem_view_font.Size = new Size(122, 22);
